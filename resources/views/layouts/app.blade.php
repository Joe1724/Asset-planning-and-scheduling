        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <i class="mr-2 text-2xl fas fa-tools"></i>
        ...
        <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between md:flex-row">
                <div class="flex items-center mb-4 md:mb-0">
                    <i class="mr-2 text-xl fas fa-tools"></i>
                    <span class="text-sm">&copy; 2025 AssetEd. All rights reserved.</span>
                </div>
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-400 transition duration-150 ease-in-out hover:text-white">
